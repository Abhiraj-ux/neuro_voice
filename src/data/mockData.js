...
export const LANGUAGES = [
    { code: 'en', name: 'English', native: 'English', flag: '🇬🇧', prompt: 'Please say: "The rainbow is a division of white light into many beautiful colors."' },
    { code: 'hi', name: 'Hindi', native: 'हिन्दी', flag: '🇮🇳', prompt: 'कृपया कहें: "इंद्रधनुष सफेद प्रकाश का अनेक सुंदर रंगों में विभाजन है।"' },
    { code: 'kn', name: 'Kannada', native: 'ಕನ್ನಡ', flag: '🇮🇳', prompt: 'ದಯವಿಟ್ಟು ಹೇಳಿ: "ಮಳೆಬಿಲ್ಲು ಬಿಳಿ ಬೆಳಕನ್ನು ಅನೇಕ ಸುಂದರ ಬಣ್ಣಗಳಾಗಿ ವಿಭಜಿಸುತ್ತದೆ."' },
    { code: 'te', name: 'Telugu', native: 'తెలుగు', flag: '🇮🇳', prompt: 'దయచేసి చెప్పండి: "హరివిల్లు తెల్లని వెలుతురును అనేక అందమైన రంగులుగా విభజిస్తుంది."' },
    { code: 'es', name: 'Spanish', native: 'Español', flag: '🇪🇸', prompt: 'Por favor diga: "El arcoíris es una división de la luz blanca en muchos colores hermosos."' },
    { code: 'ta', name: 'Tamil', native: 'தமிழ்', flag: '🇮🇳', prompt: 'தயவுசெய்து சொல்லுங்கள்: "வானவில் என்பது வெண்ணிற ஒளியை பல அழகான வண்ணங்களாக பிரிப்பதாகும்."' },
];
